<div class="modal fade" id="modal-form" tabindex="1" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="form-item" method="post" action="{{ url('/productsIn') }}" class="form-horizontal"
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body flex">
                        ...
                        <div class="form-group">
                            <label>Driver</label>
                            <select class="" id="driver" name="driver_id"></select>
                            <span class="help-block with-errors"></span>
                        </div>

                        <div class="form-group">
                            <label>Car</label>
                            <select class="" id="car" name="car_id"></select>
                            <span class="help-block with-errors"></span>
                        </div>
                        ...
                        <div class="form-group fieldInput">
                            <div class="row align-items-center ">
                                <div class="col">
                                    <div class="form-group">
                                        <label>Invoice</label>
                                        {{ Form::select('no_invoice[]', $invoice, null, [
